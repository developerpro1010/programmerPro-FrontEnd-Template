...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/platform-browser'), require('@angular/animations')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/platform-browser', '@angular/animations'], factory) :
    (factory((global.ng = global.ng || {}, global.ng.platformBrowser = global.ng.platformBrowser || {}, global.ng.platformBrowser.testing = global.ng.platformBrowser.testing || {}),global.ng.core,global.ng.platformBrowser,global._angular_animations));
}(this, function (exports,_angular_core,_angular_platformBrowser,_angular_animations) { 'use strict';
        ...
        AnimationTimelineVisitor.prototype.buildKeyframes = function (ast, startingStyles, finalStyles) {
            ...
            if (Object.keys(context.currentTimeline.getFinalKeyframe()).length == 0) {
                context.currentTimeline.properties.forEach(function (prop) {
                    ...
                    if (val == null) {
                        normalizedFinalStyles[prop] = _angular_animations.AUTO_STYLE;
                    }
                });
            }
    ...
    var /** @type {?} */ BROWSER_ANIMATIONS_PROVIDERS = [
        ...
        { provide: AnimationEngine, useClass: InjectableAnimationEngine }, {
            ...
            deps: [_angular_platformBrowser.ɵDomRendererFactory2, AnimationEngine, _angular_core.NgZone]
        }
    ];
    /**
     * Separate providers from the actual module so that we can do a local modification in Google3 to
